...
namespace SmartActS.Controllers
{
    public class SuppliesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SupplyId,SupplyCode,SupplyName,LocationId,LngTitude,Latitude,CategoryId,Address,Email,MobiPhone,Phone,Website,RankId,IsStatus,UserId")] Supply supply)
        {
            if (ModelState.IsValid)
            {
